	...
	return &handlers.Router{
		...
		CallRoutes: map[string]handlers.CallRoute{
			...
			"NotifyDisplayMessages": {
				NewRequest:     func() ocpp.Request { return new(ocpp201.NotifyDisplayMessagesRequestJson) },
				RequestSchema:  "ocpp201/NotifyDisplayMessagesRequest.json",
				ResponseSchema: "ocpp201/NotifyDisplayMessagesResponse.json",
				Handler:        NotifyDisplayMessagesHandler{},
			},
			"NotifyReport": {
		...
		CallResultRoutes: map[string]handlers.CallResultRoute{
			...
			"DataTransfer": {
				NewRequest:     func() ocpp.Request { return new(ocpp201.DataTransferRequestJson) },
				NewResponse:    func() ocpp.Response { return new(ocpp201.DataTransferResponseJson) },
				RequestSchema:  "ocpp201/DataTransferRequest.json",
				ResponseSchema: "ocpp201/DataTransferResponse.json",
