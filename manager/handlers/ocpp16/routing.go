	...
	return &handlers.Router{
		...
		CallResultRoutes: map[string]handlers.CallResultRoute{
			...
			"ChangeAvailability": {
				...
				Handler:        ChangeAvailabilityHandler{},
			},
			"DataTransfer": {
				NewRequest:     func() ocpp.Request { return new(ocpp16.DataTransferJson) },
			...
			"GetCompositeSchedule": {
				NewRequest:     func() ocpp.Request { return new(ocpp16.GetCompositeScheduleJson) },
				NewResponse:    func() ocpp.Response { return new(ocpp16.GetCompositeScheduleResponseJson) },
				RequestSchema:  "ocpp16/GetCompositeSchedule.json",
			...
			"DeleteCertificate": {
				NewRequest:     func() ocpp.Request { return new(ocpp16.DeleteCertificateJson) },
				NewResponse:    func() ocpp.Response { return new(ocpp16.DeleteCertificateResponseJson) },
				RequestSchema:  "ocpp16/DeleteCertificate.json",
